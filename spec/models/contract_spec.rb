...
RSpec.describe Contract, type: :model do
  describe "validations" do
    it { is_expected.to validate_presence_of(:external_contract_id) }
    ...
    it "validates uniqueness of `external_contract_id`" do
      ...
      expect(subject).to validate_uniqueness_of(:external_contract_id)
    end
  ...
  describe "associations" do
    it { is_expected.to belong_to(:contract_owner) }
  end
